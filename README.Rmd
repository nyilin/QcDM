...
The unit of measurement of glucose readings in the example data is mmol/L. Three
BG readings were deliberately assigned non-numeric value to illustrate the
functionality of the QcDM package to detect invalid data:
