...
#'
#' @description There are three types of intervals: hypo to next documented BG, hypo to resoultion of hypo, and resolution of hypo to next documented hypo. This function will calculate these intervals.
#' @param dat A \emph{data.table} prepared by \code{\link{DataScrubbing}}
#' @return A \emph{list} contains the time intervals.
#'
#' @author Ying Chen
#' @export
